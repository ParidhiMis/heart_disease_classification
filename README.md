...
I built this project to combine healthcare data with machine learning.
It helps learn the full ML workflow, from data preprocessing → model training → web interface.
